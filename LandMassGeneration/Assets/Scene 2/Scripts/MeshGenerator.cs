...
public class MeshData
{
    ...
    Vector3[] CalculateNormals()
    {
        ...
        {
            int normalTriangeIndex = i * 3;
            int vertexIndexA = borderTriangles[normalTriangeIndex];
            int vertexIndexB = borderTriangles[normalTriangeIndex + 1];
            int vertexIndexC = borderTriangles[normalTriangeIndex + 2];
